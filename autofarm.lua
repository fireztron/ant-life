...
game.Players.PlayerAdded:Connect(function(player)
	spawn(function()
		local success, result = pcall(function()
			if player:GetRankInGroup(4525406) > 50 then  --idk mod rank number so i just put 50
				Teleport()
			end
		end)
		if not success then
...
for i,v in pairs(game.Players:GetPlayers()) do
	spawn(function()
		local success, result = pcall(function()
			if v:GetRankInGroup(4525406) > 50 then --idk mod rank number so i just put 50
				Teleport()
			end
		end)
		if not success then
...
if LocalPlayer.Character and LocalPlayer.Character.Parent and LocalPlayer.Character:FindFirstChild("Cocoon") then
	...
	tpChar(CFrame.new(LocalPlayer.Character.HumanoidRootPart.Position.X , -10, LocalPlayer.Character.HumanoidRootPart.Position.Z))
	repeat wait() 
